...
RELEASEDIR=ValheimNewItemTemplate/bin/Release/net48
DLL=$RELEASEDIR/ValheimNewItemTemplate.dll
BUN=../chebs-necromancy/ChebsNecromancyUnity/Assets/AssetBundles/enclavesix
PLUGINS=ValheimNewItemTemplate/Package/plugins
README=README.md
...
ZIPDESTINATION="../bin/Release/net48/ValheimNewItemTemplate.$VERSION.zip"
